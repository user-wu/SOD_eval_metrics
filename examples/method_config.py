...
BASNet_root = "D:\Projects\PYSoD_New\data\experience_result/BASNet"
BASNet = {
    "ECSSD": dict(path=os.path.join(BASNet_root, "ECSSD"), suffix=".png"),
    "PASCAL_S": dict(path=os.path.join(BASNet_root, "PASCAL-S"), suffix=".png"),
    "DUT_OMRON": dict(path=os.path.join(BASNet_root, "DUT-OMRON"), suffix=".png"),
    "HKU_IS": dict(path=os.path.join(BASNet_root, "HKU-IS"), suffix=".png"),
    "DUTS_TE": dict(path=os.path.join(BASNet_root, "DUTS-TE"), suffix=".png"),
}

PoolNet_root = "D:\Projects\PYSoD_New\data\experience_result/PoolNet"
PoolNet = {
    "ECSSD": dict(path=os.path.join(PoolNet_root, "ECSSD"), suffix=".png"),
    "PASCAL_S": dict(path=os.path.join(PoolNet_root, "PASCAL-S"), suffix=".png"),
    "DUT_OMRON": dict(path=os.path.join(PoolNet_root, "DUT-OMRON"), suffix=".png"),
    "HKU_IS": dict(path=os.path.join(PoolNet_root, "HKU-IS"), suffix=".png"),
    "DUTS_TE": dict(path=os.path.join(PoolNet_root, "DUTS-TE"), suffix=".png"),
}

AFNet_root = "D:\Projects\PYSoD_New\data\experience_result/AFNet"
AFNet = {
    "ECSSD": dict(path=os.path.join(AFNet_root, "ECSSD"), suffix=".png"),
    "PASCAL_S": dict(path=os.path.join(AFNet_root, "PASCAL-S"), suffix=".png"),
    "DUT_OMRON": dict(path=os.path.join(AFNet_root, "DUT-OMRON"), suffix=".png"),
    "HKU_IS": dict(path=os.path.join(AFNet_root, "HKU-IS"), suffix=".png"),
    "DUTS_TE": dict(path=os.path.join(AFNet_root, "DUTS-TE"), suffix=".png"),
}


CAGNet_root = "D:\Projects\PYSoD_New\data\experience_result/CAGNet"
CAGNet = {
    "ECSSD": dict(path=os.path.join(CAGNet_root, "ECSSD"), suffix=".png"),
    "PASCAL_S": dict(path=os.path.join(CAGNet_root, "PASCAL-S"), suffix=".png"),
    "DUT_OMRON": dict(path=os.path.join(CAGNet_root, "DUT-OMRON"), suffix=".png"),
    "HKU_IS": dict(path=os.path.join(CAGNet_root, "HKU-IS"), suffix=".png"),
    "DUTS_TE": dict(path=os.path.join(CAGNet_root, "DUTS-TE"), suffix=".png"),
}

EGNet_root = "D:\Projects\PYSoD_New\data\experience_result/EGNet"
EGNet = {
    "ECSSD": dict(path=os.path.join(EGNet_root, "ECSSD"), suffix=".png"),
    "PASCAL_S": dict(path=os.path.join(EGNet_root, "PASCAL-S"), suffix=".png"),
    "DUT_OMRON": dict(path=os.path.join(EGNet_root, "DUT-OMRON"), suffix=".png"),
    "HKU_IS": dict(path=os.path.join(EGNet_root, "HKU-IS"), suffix=".png"),
    "DUTS_TE": dict(path=os.path.join(EGNet_root, "DUTS-TE"), suffix=".png"),
}

GateNet_root = "D:\Projects\PYSoD_New\data\experience_result/GateNet"
GateNet = {
    "ECSSD": dict(path=os.path.join(GateNet_root, "ECSSD"), suffix=".png"),
    "PASCAL_S": dict(path=os.path.join(GateNet_root, "PASCAL-S"), suffix=".png"),
    "DUT_OMRON": dict(path=os.path.join(GateNet_root, "DUT-OMRON"), suffix=".png"),
    "HKU_IS": dict(path=os.path.join(GateNet_root, "HKU-IS"), suffix=".png"),
    "DUTS_TE": dict(path=os.path.join(GateNet_root, "DUTS-TE"), suffix=".png"),
}

GCPANet_root = "D:\Projects\PYSoD_New\data\experience_result/GCPANet"
GCPANet = {
    "ECSSD": dict(path=os.path.join(GCPANet_root, "ECSSD"), suffix=".png"),
    "PASCAL_S": dict(path=os.path.join(GCPANet_root, "PASCAL-S"), suffix=".png"),
    "DUT_OMRON": dict(path=os.path.join(GCPANet_root, "DUT-OMRON"), suffix=".png"),
    "HKU_IS": dict(path=os.path.join(GCPANet_root, "HKU-IS"), suffix=".png"),
    "DUTS_TE": dict(path=os.path.join(GCPANet_root, "DUTS-TE"), suffix=".png"),
}

MINet_root = "D:\Projects\PYSoD_New\data\experience_result/MINet"
MINet = {
    "ECSSD": dict(path=os.path.join(MINet_root, "ECSSD"), suffix=".png"),
    "PASCAL_S": dict(path=os.path.join(MINet_root, "PASCAL-S"), suffix=".png"),
    "DUT_OMRON": dict(path=os.path.join(MINet_root, "DUT-OMRON"), suffix=".png"),
    "HKU_IS": dict(path=os.path.join(MINet_root, "HKU-IS"), suffix=".png"),
    "DUTS_TE": dict(path=os.path.join(MINet_root, "DUTS-TE"), suffix=".png"),
}

DFINet_root = "D:\Projects\PYSoD_New\data\experience_result/DFINet"
DFINet = {
    "ECSSD": dict(path=os.path.join(DFINet_root, "ECSSD"), suffix=".png"),
    "PASCAL_S": dict(path=os.path.join(DFINet_root, "PASCAL-S"), suffix=".png"),
    "DUT_OMRON": dict(path=os.path.join(DFINet_root, "DUT-OMRON"), suffix=".png"),
    "HKU_IS": dict(path=os.path.join(DFINet_root, "HKU-IS"), suffix=".png"),
    "DUTS_TE": dict(path=os.path.join(DFINet_root, "DUTS-TE"), suffix=".png"),
}

MLMSNet_root = "D:\Projects\PYSoD_New\data\experience_result/MLMSNet"
MLMSNet = {
    "ECSSD": dict(path=os.path.join(MLMSNet_root, "ECSSD"), suffix=".png"),
    "PASCAL_S": dict(path=os.path.join(MLMSNet_root, "PASCAL-S"), suffix=".png"),
    "DUT_OMRON": dict(path=os.path.join(MLMSNet_root, "DUT-OMRON"), suffix=".png"),
    "HKU_IS": dict(path=os.path.join(MLMSNet_root, "HKU-IS"), suffix=".png"),
    "DUTS_TE": dict(path=os.path.join(MLMSNet_root, "DUTS-TE"), suffix=".png"),
}

F3Net_root = "D:\Projects\PYSoD_New\data\experience_result/F3Net"
F3Net = {
    "ECSSD": dict(path=os.path.join(F3Net_root, "ECSSD"), suffix=".png"),
    "PASCAL_S": dict(path=os.path.join(F3Net_root, "PASCAL-S"), suffix=".png"),
    "DUT_OMRON": dict(path=os.path.join(F3Net_root, "DUT-OMRON"), suffix=".png"),
    "HKU_IS": dict(path=os.path.join(F3Net_root, "HKU-IS"), suffix=".png"),
    "DUTS_TE": dict(path=os.path.join(F3Net_root, "DUTS-TE"), suffix=".png"),
}

Ours_root = "D:\Projects\PYSoD_New\data\experience_result/Ours"
Ours = {
    "ECSSD": dict(path=os.path.join(Ours_root, "ECSSD"), suffix=".png"),
    "PASCAL_S": dict(path=os.path.join(Ours_root, "PASCAL-S"), suffix=".png"),
    "DUT_OMRON": dict(path=os.path.join(Ours_root, "DUT-OMRON"), suffix=".png"),
    "HKU_IS": dict(path=os.path.join(Ours_root, "HKU-IS"), suffix=".png"),
    "DUTS_TE": dict(path=os.path.join(Ours_root, "DUTS-TE"), suffix=".png"),
}
