...
_RGBSOD_METHODS_ROOT = "/home/userwu/Projects/PySODMetrics/data/SOD_test"
...
_METHODS_DIR_NAMES = {
    ...
    # "BASNet_2019": "BASNet",
    # "CPD_R_2019": "CPD-R",
    # "PoolNet_R_2019_1": "PoolNet_1",
    # "PoolNet_R_2019_2": "PoolNet_2",
...
# DGRL_2018 = {
    ...
    # "DUTS-TE": dict(
    #     path=os.path.join(
    #         _RGBSOD_METHODS_ROOT, _RGBSOD_DATASET_NAMES[4], _METHODS_DIR_NAMES["DUTS"]
    #     ),
    #     suffix=".png",
    # ),
    # "SOC": None,
...
#     "SOD": dict(
#         path=os.path.join(
#             _RGBSOD_METHODS_ROOT, _RGBSOD_DATASET_NAMES[5], _METHODS_DIR_NAMES["BASNet_2019"]
#         ),
#         suffix=".png",
#     ),
# }
...
#     "PASCAL-S": dict(
#         path=os.path.join(
#             _RGBSOD_METHODS_ROOT, _RGBSOD_DATASET_NAMES[0], _METHODS_DIR_NAMES["PoolNet_R_2019_1"]
#         ),
#         suffix=".png",
#     ),
#     "ECSSD": dict(
#         path=os.path.join(
#             _RGBSOD_METHODS_ROOT, _RGBSOD_DATASET_NAMES[1], _METHODS_DIR_NAMES["PoolNet_R_2019_1"]
#         ),
#         suffix=".png",
#     ),
#     "HKU-IS": dict(
#         path=os.path.join(
#             _RGBSOD_METHODS_ROOT, _RGBSOD_DATASET_NAMES[2], _METHODS_DIR_NAMES["PoolNet_R_2019_1"]
#         ),
#         suffix=".png",
#     ),
#     "DUT-OMRON": dict(
#         path=os.path.join(
#             _RGBSOD_METHODS_ROOT, _RGBSOD_DATASET_NAMES[3], _METHODS_DIR_NAMES["PoolNet_R_2019_1"]
#         ),
#         suffix=".png",
#     ),
#     "DUTS-TE": dict(
#         path=os.path.join(
#             _RGBSOD_METHODS_ROOT, _RGBSOD_DATASET_NAMES[4], _METHODS_DIR_NAMES["PoolNet_R_2019_1"]
#         ),
#         suffix=".png",
#     ),
#     "SOD": dict(
#         path=os.path.join(
#             _RGBSOD_METHODS_ROOT, _RGBSOD_DATASET_NAMES[5], _METHODS_DIR_NAMES["PoolNet_R_2019_1"]
#         ),
#         suffix=".png",
#     ),
# }
...
#     "PASCAL-S": dict(
#         path=os.path.join(
#             _RGBSOD_METHODS_ROOT, _RGBSOD_DATASET_NAMES[0], _METHODS_DIR_NAMES["PoolNet_R_2019_2"]
#         ),
#         suffix=".png",
#     ),
#     "ECSSD": dict(
#         path=os.path.join(
#             _RGBSOD_METHODS_ROOT, _RGBSOD_DATASET_NAMES[1], _METHODS_DIR_NAMES["PoolNet_R_2019_2"]
#         ),
#         suffix=".png",
#     ),
#     "HKU-IS": dict(
#         path=os.path.join(
#             _RGBSOD_METHODS_ROOT, _RGBSOD_DATASET_NAMES[2], _METHODS_DIR_NAMES["PoolNet_R_2019_2"]
#         ),
#         suffix=".png",
#     ),
#     "DUT-OMRON": dict(
#         path=os.path.join(
#             _RGBSOD_METHODS_ROOT, _RGBSOD_DATASET_NAMES[3], _METHODS_DIR_NAMES["PoolNet_R_2019_2"]
#         ),
#         suffix=".png",
#     ),
#     "DUTS-TE": dict(
#         path=os.path.join(
#             _RGBSOD_METHODS_ROOT, _RGBSOD_DATASET_NAMES[4], _METHODS_DIR_NAMES["PoolNet_R_2019_2"]
#         ),
#         suffix=".png",
#     ),
#
#     "SOD": dict(
#         path=os.path.join(
#             _RGBSOD_METHODS_ROOT, _RGBSOD_DATASET_NAMES[5], _METHODS_DIR_NAMES["PoolNet_R_2019_2"]
#         ),
#         suffix=".png",
#     ),
# }
...
F3Net_R_2020 = {
    ...
    "SOD": dict(
        path=os.path.join(
            _RGBSOD_METHODS_ROOT, _RGBSOD_DATASET_NAMES[5], _METHODS_DIR_NAMES["F3Net_R_2020"]
        ),
        suffix=".png",
    ),
}
...
methods_info_for_drawing = OrderedDict(
    {
        ...
        # "PoolNet_R_2019_1": curve_info(PoolNet_R_2019_1, "PoolNet_R_2019_1"),
        # "PoolNet_R_2019_2": curve_info(PoolNet_R_2019_2, "PoolNet_R_2019_2"),
...
methods_info_for_selecting = OrderedDict(
    {
        ...
        # "BASNet_2019": simple_info(BASNet_2019, "BASNet_2019"),
        # "CPD_R_2019": simple_info(MINet_R_2020, "CPD_R_2019"),
        # "PoolNet_R_2019_1": simple_info(PoolNet_R_2019_1, "PoolNet_R_2019_1"),
        # "PoolNet_R_2019_2": simple_info(PoolNet_R_2019_2, "PoolNet_R_2019_2"),
        ...
        "F3Net_R_2020": simple_info(F3Net_R_2020, "F3Net_R_2020"),
